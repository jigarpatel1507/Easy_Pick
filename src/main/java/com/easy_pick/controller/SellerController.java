...
import com.easy_pick.domain.AccountStatus;
...
import com.easy_pick.repository.VerificationCodeRepository;
import com.easy_pick.response.ApiResponse;
import com.easy_pick.response.AuthResponse;
import com.easy_pick.service.*;
import com.easy_pick.service.impl.CustomeUserServiceImplementation;
import com.easy_pick.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Easy Pick Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Easy Pick Email Verification Code";
        String text = "Welcome to Easy Pick, verify your account using this link ";
