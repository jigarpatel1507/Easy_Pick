...
import com.easy_pick.service.AuthService;
import com.easy_pick.service.EmailService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void sentLoginOtp(String email) throws UserException, MessagingException {
        ...
        String subject = "Easy Pick Login/Signup Otp";
    ...
    public String createUser(SignupRequest req) throws SellerException {
        ...
        if (user == null) {
            ...
            createdUser.setMobile("8866669095");
